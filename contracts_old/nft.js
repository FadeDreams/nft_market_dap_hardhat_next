...
describe("NFT Marketplace", function() {
  ...
  beforeEach(async () => {
    ...
    // Assign the address of the deployed contract to nftMarketAddress
  ...
  describe("Mint and list a new NFT token", function() {
    ...
    it("Should emit MarketItemCreated after successfully listing of NFT", async function() {
      ...
      await expect(transaction).to.emit(nftMarket, 'MarketItemCreated').withArgs(tokenID, contractOwner.getAddress(), nftMarketAddress, auctionPrice, false);
